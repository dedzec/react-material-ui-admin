...
const Page401 = (props) => {
  ...
  useEffect(() => {
    props.onToggleDynamicBreadcrumbs(['dashboard', 'errors', '401']);
  }, [props]);
  ...
  const info = () => (
    <div>
      <MyStyled.TextPrimary variant="h3">Whoops, 401</MyStyled.TextPrimary>
      <p>{t('error.401')}</p>
...
export default connect(mapStateToProps, mapDispatchToProps)(Page401);
