      ...
      <CardContent>
        <Grid container spacing={2}>
          <Grid item xs={12} align="center">
            <MyStyled.ButtonSuccess variant="outlined">
              Success
            </MyStyled.ButtonSuccess>
            <MyStyled.ButtonError variant="outlined">
              Error
            </MyStyled.ButtonError>
            <MyStyled.ButtonNeutral variant="outlined">
              Neutral
            </MyStyled.ButtonNeutral>
            <MyStyled.ButtonAccent variant="outlined">
              Accent
